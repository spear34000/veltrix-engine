...
static const arch_entry arch_table[] = {
    ...
    {"qwen3",    VX_ARCH_QWEN2,    VX_MLP_SWIGLU, VX_NORM_RMS,   0, false, false, false, false},
    {"qwen3.5",  VX_ARCH_QWEN2,    VX_MLP_SWIGLU, VX_NORM_RMS,   0, false, false, false, false},
    {"qwen3.6",  VX_ARCH_QWEN2,    VX_MLP_SWIGLU, VX_NORM_RMS,   0, false, false, false, false},
    {"qwen3moe", VX_ARCH_QWEN2,    VX_MLP_SWIGLU, VX_NORM_RMS,   0, false, false, false, false},
    ...
    {"mistralnemo", VX_ARCH_MISTRAL, VX_MLP_SWIGLU, VX_NORM_RMS, 0, false, false, false, false},
    ...
    {"gemma3",   VX_ARCH_GEMMA,    VX_MLP_GEGLU,  VX_NORM_RMS,   0, true,  true,  true,  false},
    {"gemma-3",  VX_ARCH_GEMMA,    VX_MLP_GEGLU,  VX_NORM_RMS,   0, true,  true,  true,  false},
    {"gemma4",   VX_ARCH_GEMMA,    VX_MLP_GEGLU,  VX_NORM_RMS,   0, true,  true,  true,  false},
    {"gemma-4",  VX_ARCH_GEMMA,    VX_MLP_GEGLU,  VX_NORM_RMS,   0, true,  true,  true,  false},
